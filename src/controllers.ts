...
const NASA_API_KEY = "moraCBy8AOsu6FLuYUSxu5juPwSl9moTK82W8I9l";
const URL_ROVERS_LIST = "https://api.nasa.gov/mars-photos/api/v1/rovers";

const roversResponseJson = require('../data/roversresponse.json');
